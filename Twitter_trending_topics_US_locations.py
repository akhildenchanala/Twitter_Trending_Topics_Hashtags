...
def main():
    ...
    US_location = US_location[US_location['woeid'].isin([23424977])==False]
    ...
    trends = trends[trends['woeid'].isin([1])==False]
    ...
    trends_all.to_json('twitter_trending_topics_of_US_locations.json',orient='records')
